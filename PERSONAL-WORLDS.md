...
- **Blocks / possible cities:** A second physics scene with towers, cylinders, triangular wedges, and bridges. Trees and shared paths frame the wooden city. Field notes connect childhood building to Don’s ambition for walkable, accessible, nature-integrated places. These are playful sketches, not an urban planning simulation.
